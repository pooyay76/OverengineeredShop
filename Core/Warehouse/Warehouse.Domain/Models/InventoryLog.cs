...
{
    public class InventoryLog : AggregateRootBase<InventoryLogId>
    {
        ...
        internal InventoryLog(ProductItemId productItemId,int quantity, bool isReduction,UserId operatorId ,string operatorName, string description="")
        {
        ...
        internal InventoryLog(UserId customerId,BillId billId,ProductItemId productItemId, int quantity)
        {
